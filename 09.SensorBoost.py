...
# Puzzle input
INPUT_TEST = '''109,1,203,2,204,2,99'''
...
# Intcode computer class, taken from Day 07
# Changes: 
#   (1) Supports relative mode => modified method self.read_param() + new method self.write_param().
#       Write operations in instructions 1,2,7,8 also changed
#   (2) Computer memory is now implemented as a dictionary instead of list. 
...
# create a computer, initialize 1st input and run instructions until next input instruction
...
# set input to a computer and run until next input instruction
